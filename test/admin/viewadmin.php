...
<div class="container">
    <div class="table-container">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                $query = "SELECT user.*, role.roleName FROM user
                        ...
                        WHERE (user.username LIKE '%$searchTerm%' OR user.firstName LIKE '%$searchTerm%' OR user.email LIKE '%$searchTerm%') AND user.roleID = 1"; // Only show records with roleID = 1
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    // Add Update button with a link to updateadmin.php
                    echo "<td><a href='updateadmin.php?id=" . $row['userID'] . "' class='btn btn-warning'>Update</a></td>";
        ...
        <div class="add-user-btn">
            <a href="addadmin.php" class="btn btn-primary">Add New Admin</a>
        </div>
    </div>
</div>
